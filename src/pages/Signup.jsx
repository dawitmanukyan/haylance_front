...
function Signup() {
    ...
    return (
        <div className={classes.loginpanel}>
            ...
            <hr className={classes.signuprespline}></hr>
            <p className={classes.signupheaderresp}>Already registered ?</p>
            <p className={classes.signupheaderresp}>log in to your account</p>
            <div className={classes.respbtndiv}>
                <Link to='/signin' className={classes.respsignlink}>
                    <button className={classes.lgbtnsignresp}>Sign In</button>
                </Link>
            </div>
